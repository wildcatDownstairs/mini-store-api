...
public static class PaymentEndpoints
{
    ...
    public static void MapPayments(this WebApplication app)
    {
        app.MapPost(
                ...
                ) => ApiResponse.OkAsync(service.SimulateCustomerAsync(id, r, user.ActorId(), ct))
            )
        ...
        app.MapPost(
                ...
                (
                    ...
                    PaymentService service,
                    CancellationToken ct
                ) => ApiResponse.OkAsync(service.SimulateAdminAsync(id, r, ct))
            )
        ...
        admin
            .MapGet(
                "/refunds",
                ([AsParameters] ListQuery q, PaymentService service, CancellationToken ct) =>
                    ApiResponse.OkAsync(service.ListRefundsAsync(q, ct))
            )
        ...
        admin
            .MapPost(
                ...
                (RefundRequest r, PaymentService service, CancellationToken ct) =>
                    ApiResponse.OkAsync(service.RequestRefundAsync(r, ct))
            )
            .RequireAuthorization("AdminWrite")
