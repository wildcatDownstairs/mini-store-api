...
public static class AuthEndpoints
{
    ...
    public static void MapAuth(this WebApplication app)
    {
        ...
        group
            .MapPost(
                ...
                (RegisterRequest request, AuthService service, CancellationToken ct) =>
                    ApiResponse.OkAsync(service.RegisterAsync(request, ct))
            )
            ...
            .Produces<ApiResponse<object?>>(429)
        ...
        group
            .MapPost(
                ...
                (LoginRequest request, AuthService service, CancellationToken ct) =>
                    ApiResponse.OkAsync(service.LoginAsync(request, ct))
            )
        ...
        app.MapPost(
                ...
                (LoginRequest request, AuthService service, CancellationToken ct) =>
                    ApiResponse.OkAsync(service.LoginAdminAsync(request, ct))
            )
